    ...
    <div class="product-page">
      ...
      <div class="product-page__description-wrapper">
        ...
        <div class="product-page__count">
          <Button class="product-page__count-btn" @click="decrement">-</Button>
          <span>{{ count }}</span>
          <Button class="product-page__count-btn" @click="increment">+</Button>
        </div>
        <p class="product-page__price">
          Цена:
          <span class="product-page__price-item">{{ data.price }}</span>
          ₽
        </p>
