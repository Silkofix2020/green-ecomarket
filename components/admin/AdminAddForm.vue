<template>
  <form @submit.prevent="addProduct" enctype="multipart/form-data">
    ...
    <textarea v-model="product.description" placeholder="Описание"></textarea>
    <textarea
      v-model="product.short_description"
      placeholder="Короткое описание"
    ></textarea>
    <Input v-model="product.price" placeholder="Цена: 1000" type="number" />
    <Input
    ...
    <input type="file" multiple @change="onAltImagesChange" accept="image/*" />
